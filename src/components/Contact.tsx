...
const Contact = () => {
    return (
        <div className='max-w-[1000px] mx-auto flex flex-col lg:flex-row text-white/70 p-8 
            ...
            <div className='bg-white/10 p-7 rounded-xl max-w-[500px]'>
            <h2 className='text-5xl font-bold text-orange-400 mb-4'>Let's connect</h2>
            <p className='text-white/70 mb-6'>Send me a menssage and lets schedule a call</p>
            <form className='space-y-4' action="https://getform.io/f/bqongyrb" method='POST'>
