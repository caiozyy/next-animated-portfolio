        ...
        <div className='max-w-[1000px] md:mx-auto flex flex-col lg:flex-row text-white/70 p-8 
            ...
            <form className='space-y-4 mt-6' action="https://getform.io/f/bqongyrb" method='POST'>
                <div className='grid md:grid-cols-2 gap-4'>
                    <input type="text" name="firstName" className='bg-white/10 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' 
                    placeholder='First Name' />
                    <input type="text" name="lastName" className='bg-white/10  rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' 
                    placeholder='Last Name' />
                    <input type="email" name="email" className='bg-white/10  rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' 
                    placeholder='Email' />
                    <input type="tel" name="phone" className='bg-white/10  rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' 
                    placeholder='Phone' />
                </div>
                <textarea name="message" className='bg-white/10  w-full rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' 
