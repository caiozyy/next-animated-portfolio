                ...
                <div className='w-full md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden'>
                    ...
                    <div className='flex flex-row p-6'>
                        ...
                        <div className='flex flex-col mt-4'>
                            ...
                            <p className='text-lg text-white/70 mt-2'> I'm currently studying in the 4th semester of my Systems Analysis and Development program at IESB University - Brasília.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='w-full md:col-span-3 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden'>
                    ...
                    <div className='flex flex-row p-6'>
                        ...
                        <div className='flex flex-col mt-4'>
                            ...
                            <p className='text-lg text-white/70 mt-2'> I have great creativity, good communication, and analytical skills</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='w-full md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden'>
                    ...
                    <div className='flex flex-row p-6'>
                        ...
                        <div className='flex flex-col mt-4'>
                            ...
                            <p className='text-lg text-white/70 mt-2'> I'm learning English, currently at an intermediate level and I have experience with SQL, Javascript, React, Next, Typescript, HTML, CSS, data analysis, data visualization.</p>
                        </div>
                    </div>
                </div>
